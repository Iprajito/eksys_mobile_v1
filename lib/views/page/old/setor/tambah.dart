...
class TambahSetorSaldoPage extends StatefulWidget {
  final String? token;
  final String? outletId;
  final String? newnota;
  const TambahSetorSaldoPage({super.key, this.token, this.outletId, this.newnota});

  @override
  State<TambahSetorSaldoPage> createState() => _TambahSetorSaldoPageState();
}

class _TambahSetorSaldoPageState extends State<TambahSetorSaldoPage> {
  ...
  void _saveForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      var response = await setorSaldoController.saveSetorSaldo(widget.token.toString(),
          '', widget.outletId.toString(), nota, tanggal, nominal);
      if (response) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Tambah Setor Saldo",
            style: TextStyle(
              ...
              Card(
                ...
                child: ListTile(
                  ...
                  subtitle: TextFormField(
                    controller: TextEditingController(text: widget.newnota),
