...
class FormKegiatanDetailManager {
  final List<FormKegiatanDetail> _entries = [];

  List<FormKegiatanDetail> get entries => _entries;

  void addEntry(String userid,String kegiatan_id, String wilayah_id, String anggota_id) {
    _entries.add(FormKegiatanDetail(
      userid: userid,
  ...
  List<FormKegiatanDetail> getEntries(String id) {
...
class KegiatanDetailPage extends StatefulWidget {
  ...
  const KegiatanDetailPage({super.key, this.token, this.userid, this.id, this.usergroup});
...
class _KegiatanDetailPageState extends State<KegiatanDetailPage> {
  ...
  KegiatanDispatchModel? _kegiatanDispatchModel;
  ...
  void _dataPembelian(String token, String userid, String idencrypt) async {
    ...
    KegiatanModel? data = await kegiatanController.getkegiatanbyid(token, userid, idencrypt);
    if (mounted) {
      setState(() {
        _kegiatanModel = data;
        if (_kegiatanModel?.data[0].file_kegiatan.toString() != '') {
          fileList = List<String>.from(jsonDecode(_kegiatanModel!.data[0].file_kegiatan.toString()));
        }
  ...
  void _dataPembelianDetail(String token, String idencrypt) async {
    KegiatanDispatchModel? data = await kegiatanController.getkegiatandispatchbyid(token, idencrypt);
    if (mounted) {
      setState(() {
        _kegiatanDispatchModel = data;
      });
    }
  }
  ...
  void _saveKegiatanSelesai() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (notulensi.isEmpty) {
        ...
        kegiatanController = KegiatanController();
        var response = await kegiatanController.saveKegiatanSelesai(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Detail Kegiatan", style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700)),
          ...
          child: Form(
            ...
            child: Column(
              children: [
                          ...
                          BootstrapCol(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                : Text(
                                  _kegiatanModel!.data[0].namakegiatan.toString(),
                          ...
                          BootstrapCol(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                                : Text(
                                  _kegiatanModel!.data[0].aktifitas.toString(),
                                  style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                                ),
                              ],
                            ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                                  : Text(
                                    '${formatDate(_kegiatanModel!.data[0].tgl_kegiatan.toString())}, ${_kegiatanModel!.data[0].jam_kegiatan.toString()}',
                                    style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                                  ),
                                ],
                              ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _kegiatanModel == null
                                  ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                                  : Text(CurrencyFormat.convertToIdr((int.parse(_kegiatanModel!.data[0].nominal_iuran.toString())),0),
                                    style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                                  ),
                                ],
                              ),
                          ...
                          BootstrapCol(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                                : Text(
                                  _kegiatanModel!.data[0].lokasi.toString(),
                                  style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                                ),
                              ],
                            ),
                          ...
                          BootstrapCol(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                                : Text(
                                  _kegiatanModel!.data[0].creator.toString(),
                                  style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                                ),
                              ],
                            ),
                              ...
                              children: [
                                Text("Data Undangan",
                                    style: TextStyle(
                                        ...
                                        fontSize: 14)),
                                Visibility(
                                  visible: (_kegiatanModel?.data[0].status.toString() == 'Selesai') ? false : true,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: _kegiatanDispatchModel == null
                                  ? const ListMenuShimmer(total: 4, circular: 4, height: 42)
                                  : _kegiatanDispatchModel!.data.isEmpty
                                      ? const Center(
                                          child: Text('Belum ada data'))
                                      : ListView.builder(
                                          physics: ScrollPhysics(parent: ClampingScrollPhysics()),
                                          itemCount: _kegiatanDispatchModel!.data.length,
                                          itemBuilder: (context, index) {
                                            var item = _kegiatanDispatchModel!.data[index];
                                  ...
                                  Padding(
                                    ...
                                    child: _kegiatanModel == null ? const Text('Partisipan : 0 Anggota')
                                        : Text('Partisipan : ${CurrencyFormat.convertNumber((int.parse(_kegiatanModel!.data[0].participant.toString())),0)} Anggota'),
                                  )
                                ],
                              ),
                            ),
                ...
                const SizedBox(height: 16),
                Visibility(
                  visible: (_kegiatanModel?.data[0].is_hadir == '1'  && widget.userid == _kegiatanModel?.data[0].creator_userid) ? true : false,
                  child: Container(
                    decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(8.0)),
                      ...
                      children: [
                        ...
                        BootstrapRow(
                          ...
                          children: [
                            BootstrapCol(
                              sizes: 'col-12',
                              child: (_kegiatanModel?.data[0].status.toString() == 'Baru') ?
                              TextFormField(
                                maxLines: 3,
                              ...
                              ) : (_kegiatanModel == null) ? const Text('') : Text(_kegiatanModel!.data[0].notulensi.toString())
                            ),
                          ],
                        ),
                        Visibility(
                          visible: (_kegiatanModel?.data[0].status.toString() == 'Baru') ? true : false,
                          child: BootstrapRow(
                            height: 30,
                            children: [
                              BootstrapCol(
                ...
                const SizedBox(height: 16),
                Visibility(
                  visible: (_kegiatanModel?.data[0].status.toString() == 'Selesai') ? true : false,
                  child: Container(
                    decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(8.0)),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          (_kegiatanModel?.data[0].is_hadir == '1' && widget.userid == _kegiatanModel?.data[0].creator_userid) ? 
                          Container(
                            width: (screenWidth) - 16,
                            child: ElevatedButton(
                              onPressed: _saveKegiatanSelesai,
                              ...
                              child: Text(
                                'Simpan Notulensi & Kegiatan Selesai',
                                style: TextStyle(
  ...
  Widget listAttach(int index, String filename) {
    ...
    String url = "https://erp.eahm-indonesia.co.id/treasure/uploads/mobile/kegiatans/$filename";
...
class _ProdukPageState extends State<ProdukPage> {
  ...
  final FormKegiatanDetailManager _entryManager = FormKegiatanDetailManager();
  ...
  void _addEntry(wilayah_id, kegiatan_id, anggota_id) {
    setState(() {
      if (_entryManager.entryExists(wilayah_id) == false) {
        _entryManager.addEntry(widget.userid.toString(), kegiatan_id, wilayah_id, anggota_id);
      }
    });
  ...
  void _addEntryAnggota(wilayah_id, kegiatan_id, anggota_id) {
    setState(() {
  ...
  void _saveProduks() async {
    ...
    if (_entryManager.entries.length > 0) {
      ...
      for (var entry in _entryManager.entries) {
        await kegiatanController.saveKegiatanDispatch(widget.token.toString(), widget.id.toString(), entry);
      }
      hideLoadingDialog(context);
    }
    Navigator.pop(context, 'refresh');
