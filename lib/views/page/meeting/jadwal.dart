...
class JadwalMeetingPage extends StatefulWidget {
  final String? token;
  final String? userid;
  const JadwalMeetingPage({super.key, this.token, this.userid});

  @override
  State<JadwalMeetingPage> createState() => _JadwalMeetingPageState();
}

class _JadwalMeetingPageState extends State<JadwalMeetingPage> {
  ...
  Future<void> _checkToken() async {
    ...
    if (check == 'success') {
      // print('Valid Token');
      _dataUser();
      _dataJadwaMeeting(widget.token, widget.userid);
    } else {
      if (mounted) {
