...
class PenjualanDetailPage extends StatefulWidget {
  ...
  const PenjualanDetailPage({super.key, this.token, this.userid, this.idencrypt});

  @override
  State<PenjualanDetailPage> createState() => _PenjualanDetailPageState();
}
...
class _PenjualanDetailPageState extends State<PenjualanDetailPage> {
  ...
  PenjualanDetailModel? _penjualanDetailModel;
  ...
  Future<void> _dataUser() async {
    ...
    if (mounted) {
      ...
      setState(() {
        ...
        _dataPenjualan(widget.token.toString(), widget.userid.toString(), widget.idencrypt.toString());
        _dataPenjualanDetail(widget.token.toString(), widget.userid.toString(), widget.idencrypt.toString());
        isLoading = false;
      });
    }
  }
  ...
  void _dataPenjualan(String token, String userid, String idencrypt) async {
    PenjualanModel? data =
        await salesorderController.getpenjualanbyid(token, userid, idencrypt);
    if (mounted) {
      setState(() {
  ...
  void _dataPenjualanDetail(String token, String userid, String idencrypt) async {
    PenjualanDetailModel? data =
        await salesorderController.getpenjualandetailbyid(token, userid, idencrypt);
    if (mounted) {
      setState(() {
        _penjualanDetailModel = data;
      });
    }
  }
  ...
  void _batalPesanan() async {
    showLoadingDialog(context: context);
    var response = await salesorderController.savePenjualanBatal(widget.token.toString(), widget.userid.toString(), widget.idencrypt.toString());
    if (response) {
      hideLoadingDialog(context);
      Navigator.pop(context, 'refresh');
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Detail Penjualan", style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700)),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                : Text(
                                  _penjualanModel!.data[0].nomor_so.toString(),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                                : Text(
                                  formatDate(_penjualanModel!.data[0].tgl_so.toString()),
                                  style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                                ),
                              ],
                            ),
                        ...
                        BootstrapCol(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                              : Text(
                                _penjualanModel!.data[0].pelanggan.toString(),
                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                              ),
                            ],
                          ),
                        ...
                        BootstrapCol(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ? const ListMenuShimmer(total: 1, circular: 4, height: 16)
                              : Text(
                                _penjualanModel!.data[0].keterangan.toString(),
                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                              ),
                            ],
                          ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: _penjualanDetailModel == null
                                ? const ListMenuShimmer(total: 4, circular: 4, height: 42)
                                : _penjualanDetailModel!.data.isEmpty
                                    ? const Center(
                                        child: Text('Belum ada pesanan'))
                                    : ListView.builder(
                                        physics: ScrollPhysics(parent: ClampingScrollPhysics()),
                                        itemCount: _penjualanDetailModel!.data.length,
                                        itemBuilder: (context, index) {
                                          var item = _penjualanDetailModel!.data[index];
                                          ...
                                          var harga = double.parse(item.hrgjualSatuan.toString());
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      _penjualanModel == null ? const Text('Total 0 Produk, 0 Karton')
                                      : Text('Total ${CurrencyFormat.convertNumber((int.parse(_penjualanModel!.data[0].item.toString())),0)} Produk, ${CurrencyFormat.convertNumber((int.parse(_penjualanModel!.data[0].qty.toString())),0)} Karton'),
                                      
                                      _penjualanModel == null ? const Text('Rp 0')
                                      : Text(
                                          CurrencyFormat.convertToIdr((int.parse(_penjualanModel!.data[0].subtotal.toString())),0),
                                          style: TextStyle(
                                              color: Colors.grey[800],
                                              fontSize: 16,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            _penjualanModel == null ? const Text('Rp 0')
                                            : Text(CurrencyFormat.convertToIdr((int.parse(_penjualanModel!.data[0].subtotal.toString())),0)),
                                          ],
                                        ),
                                        ...
                                        //       _penjualanModel == null ? const Text('Rp 0') :
                                        //       Text(CurrencyFormat.convertToIdr((int.parse(_penjualanModel!.data[0].jumlahdp.toString())),0)),
                                        //     ],
                                        //   ),
                                        // ),
                                        // Visibility(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            _penjualanModel == null ? const Text('Rp 0') :
                                            Text(CurrencyFormat.convertToIdr((int.parse(_penjualanModel!.data[0].transaksi_fee.toString())),0)),
                                          ],
                                        ),
                                        const SizedBox(height: 8),
                                        Divider(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              const Text(
                                                  'Total Pembayaran'),
                                              _penjualanModel == null ? const Text('Rp 0') :
                                              Text(CurrencyFormat.convertToIdr((int.parse(_penjualanModel!.data[0].grandtotal.toString())),0),
                                                  style: TextStyle(
                                                      color:
                                                          Colors.grey[800],
                                                      fontSize: 16,
      ...
      bottomNavigationBar: _penjualanModel == null ? Text('') : 
        Container(
            decoration: BoxDecoration(
              boxShadow: <BoxShadow>[
                BoxShadow(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Visibility(
                    visible: _penjualanModel?.data[0].status.toString() == 'Belum Bayar' ? true : false,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        SizedBox(
                  ...
                  Visibility(
                    visible: _penjualanModel?.data[0].status.toString() == 'Tunggu Pembayaran' ? true : false,
                    child: SizedBox(
                  ...
                  Visibility(
                    visible: _penjualanModel?.data[0].status.toString() == 'Batal' ? true : false,
                    child: Text('Penjualan Telah Dibatalkan', style: TextStyle(color: Colors.grey[800], fontSize: 16, fontWeight: FontWeight.w600),),
                  ),
                  Visibility(
                    visible: _penjualanModel?.data[0].status.toString() == 'Lunas' ? true : false,
                    child: Text('Download Invoice', style: TextStyle(color: Colors.grey[800], fontSize: 16, fontWeight: FontWeight.w600),),
                  )
                ],
              ),
            )
